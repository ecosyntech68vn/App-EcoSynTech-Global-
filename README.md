...
[![Version](https://img.shields.io/badge/version-4.0.0-2ecc71.svg)](./package.json)
...
- **Tier-based pricing rõ ràng.** Home / Farmer / HTX / Enterprise — feature gating làm kênh upsell trong app.
- **Android-first qua Capacitor.** APK + AAB cho CH Play, build local Windows 1 lỊnh.
- **Multi-tier sync.** LAN-first (WLC) → Cloud fallback (GAS) tự động, JWT auto-refresh.
- **Bảo mật V3.1.** Android Keystore cho JWT/PIN, TLS policy, OTA SHA-256 verify, dead-letter sync, background runner.
